...
function Tabelle(){
    ...
    return(
        <div className="mt-14">
        <h1 className='flex items-center ml-7 text-4xl font-black'><FiPackage />Ultime release</h1>
            {/*tabella1*/}
       <div className='mt-3 grid grid-cols-1 md:grid-cols-2'>
        <div className=' lg:grid-cols-3  gap-5 m-7'>
             <div className="bg-giallo text-giallo m-4 rounded-lg">
                        <h1 className="bg-blu p-2 w-6/12 rounded-lg mt-2 mx-auto text-center text-giallo">Ultime versioni</h1>
           ...
           {/*tabella2*/}
            <div className='md:grid-cols-2 lg:grid-cols-3  gap-5 m-7'>
                <div className="bg-giallo text-giallo m-4 rounded-lg">
                    <h1 className="bg-blu p-2 w-7/12 rounded-lg mt-2 mx-auto text-center text-giallo">Desktop Environment</h1>
                    <ul className="mt-3 bg-blu m-3 rounded-lg p-2 space-y-3">
                        {
